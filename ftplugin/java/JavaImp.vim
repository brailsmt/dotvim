...
"        silent exe "bw! " g:JavaImpClassList
"    endif
"
...
"        return ""
"    elseif (importCtr == 1)
"        return substitute(importLine, "\n", "", "")
"    else
"        return <SID>JavaImpChooseImport(importCtr, a:className, importLine)
"    endif
"endfun
"
"" -------------------------------------------------------------------  
...
"    let impList = reverse(sort(split(a:imports)))
"    let choice = <SID>JavaImpDisplayChoices(impList, a:className)
"
"    if (choice == 0)
"        return
"    else
"        let choice = choice - 1
"        return impList[choice]
"    endif
"endfun
"
"fun! <SID>JavaImpDisplayChoices(imps, className)
"    let choiceList =  ["Multiple matches for " . a:className . " were found. Which do you wish to import?"]
"
"    let ctr = 0
"    for imp in a:imps
"        let ctr = ctr + 1
"        call add(choiceList, "   " . ctr . ") " . imp)
"    endfor
"
...
"    endif
"
"    if (match(a:str1, '^\s*import\s*org.*') >= 0 && match(a:str2, '^\s*import\s*org.*') == -1)
"        return -1
"    endif
"
"    if (match(a:str1, '^\s*import\s*org.*') == -1 && match(a:str2, '^\s*import\s*org.*') >= 0)
"        return 1
"    endif
"
"    if (a:str1 < a:str2)
